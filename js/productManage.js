    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < books.length; i++) {
                ...
                table += '<td><button type="button" class="btn btn-outline-warning" id="editBook" data-bs-toggle="modal" data-bs-target="#modalProduct"">Edit</button>';
                table += '<button type="button" class="btn btn-outline-danger" id="deleteBook">Delete</button></td>';
                table += '</tr>';
