    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < orders.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning " data-bs-toggle="modal" data-bs-target="#modalOrder" id="btnDetail">Detail</button>'
                table += '</td>'
                table += '</tr>'
...
function loadValueModal(order) {
    ...
    $('#totalOrder').html('Total Order: ' + total)
