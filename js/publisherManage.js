    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < publishers.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning" id ="editPublisher" data-bs-toggle="modal" data-bs-target="#modalPublisher">Edit</button>'
                table += '<button type="button " class="btn btn-outline-danger " id ="deletePublisher">Delete</button>'
                table += '</td>'
                table += ' </tr>'
