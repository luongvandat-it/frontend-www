    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < suppliers.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning" id ="editSupplier" data-bs-toggle="modal" data-bs-target="#modalSupplier">Edit</button>'
                table += '<button type="button " class="btn btn-outline-danger " id ="deleteSupplier">Delete</button>'
                table += '</td>'
                table += ' </tr>'
