    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < users.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning " data-bs-toggle="modal" data-bs-target="#modalAccount" id="editAccount">Edit</button>'
                table += '<button type="button " class="btn btn-outline-danger " id="deleteAccount">Delete</button>'
                table += '</td>'
                table += ' </tr>'
...
function deleteUser(email) {
    $.ajax({
        url: "http://localhost:8080/api/user_s/deleteUser",
        data: {
            email: email
        },
        success: function(data) {
