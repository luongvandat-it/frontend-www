    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < authors.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning" id ="editAuthor" data-bs-toggle="modal" data-bs-target="#modalAuthor">Edit</button>'
                table += '<button type="button " class="btn btn-outline-danger " id ="deleteAuthor">Delete</button>'
                table += '</td>'
                table += ' </tr>'
