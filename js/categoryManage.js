    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < categories.length; i++) {
                ...
                table += '<td><button type="button " class="btn btn-outline-warning" id ="editCategory" data-bs-toggle="modal" data-bs-target="#modalCategory">Edit</button>'
                table += '<button type="button " class="btn btn-outline-danger " id ="deleteCategory">Delete</button>'
                table += '</td>'
                table += ' </tr>'
